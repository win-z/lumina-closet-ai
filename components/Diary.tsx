  ...
  return (
    <div className="p-4 pb-28 space-y-6">
      ...
      {isModalOpen && selectedDate && (
        <div className="fixed inset-0 z-[9999] flex items-end justify-center p-4 pb-24"
          onTouchMove={(e) => e.stopPropagation()}
        >
          <div
            className="absolute inset-0 bg-black/50 backdrop-blur-sm animate-fade-in touch-none"
            onClick={() => setIsModalOpen(false)}
          />
          <div className="relative w-full max-w-lg bg-white rounded-3xl shadow-2xl overflow-hidden max-h-[calc(100dvh-7rem)] flex flex-col animate-slide-up">
            {/* Handle */}
      ...
      {/* 搭配选择器弹窗 */}
      {showOutfitSelector && (
        <div className="fixed inset-0 z-[99999] flex items-end justify-center p-4 pb-24"
          onTouchMove={(e) => e.stopPropagation()}
        >
          <div
            className="absolute inset-0 bg-black/50 backdrop-blur-sm animate-fade-in touch-none"
          ...
          />
          <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden max-h-[calc(100dvh-7rem)] flex flex-col animate-slide-up">
            {/* Handle */}
            <div className="flex justify-center pt-3 pb-1 shrink-0">
              <div className="w-12 h-1.5 bg-slate-200 rounded-full" />
            </div>
